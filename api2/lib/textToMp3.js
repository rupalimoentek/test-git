...
var TextToMp3 = function () { }
  ...
  TextToMp3.prototype.getMp3 = function (text, callback) {
    ...
    if(typeof callback !== 'undefined' && typeof(callback) == 'function'){
      ...
      var cs = md5('3'+'1'+'1'+text+'mp3'+'7098650'+'2656499'+'3d496281358a70005e77bd97cf2643a2');
      var path = 'https://www.vocalware.com/tts/gen.php?EID=3&LID=1&VID=1&TXT='
      path += encodeURIComponent(text);
      path +='&EXT=mp3&FX_TYPE=&FX_LEVEL=&ACC=7098650&API=2656499&SESSION=&HTTP_ERR=&CS=' + cs;
      request
        .get({
          headers: {
          ...
          uri: path,
          method: 'GET',
          strictSSL: false //// This will ignore cert error from vocalware
        })
